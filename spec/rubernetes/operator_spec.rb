  ...
  describe '#initialize' do
    context 'with default options' do
      ...
      it 'sets default options' do
        expect(subject.instance_variable_get(:@options)).to eq(sleepTimer: 1, namespace: nil,
    ...
    context 'with custom options' do
      ...
      it 'sets custom options' do
        expect(subject.instance_variable_get(:@options)).to eq(sleepTimer: 5, namespace: 'mynamespace',
